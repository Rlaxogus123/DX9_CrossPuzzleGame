                                     ...
                                     void* pUserContext )
{
	...
	mciSendString(L"open res/BGM.mp3 type mpegvideo alias bgm",NULL,NULL,NULL);
...
void CALLBACK OnMouse(bool bLeftButtonDown, bool bRightButtonDown, bool bMiddleButtonDown, bool bSideButton1Down, bool bSideButton2Down, int nMouseWheelDelta, int xPos, int yPos, void* pUserContext)
{
	...
	if (bRightButtonDown)
	{
		Director::GetIns()->rClickNum = 1;
	}
	else if (!bRightButtonDown)
	{
		Director::GetIns()->rClickNum = 3;
	}
}
...
int main()
{
    ...
    DXUTCreateWindow( L"Cross Puzzle Game" );
